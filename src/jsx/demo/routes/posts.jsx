                              ...
                              <Col xs={12}>
                                <div>
                                  <div style={{paddingTop: 12.5, paddingBottom: 12.5}}>
                                    {"Hi! My name is Mathieu Roux and I'm an innate minimalist."}
                                  </div>
                                </div>
                              </Col>
                            </Row>
                          ...
                          <Row>
                            <Col xs={12} className='text-center'>
                              <div className='text-left'>
                                ...
                                <div>
                                  <Link to='/app/blog/post'><LoremIpsum className='text-capitalize' query='3w'/></Link>
                                  <div><small className='fg-darkgray50'><em>4 months ago</em> - <span className='fg-lightgreen'>Mathieu Roux</span></small></div>
                                </div>
                              </div>
                            </Col>
                          </Row>
